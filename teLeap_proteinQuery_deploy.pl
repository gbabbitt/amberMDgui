...
######################################################################
print "checking teLeap output files\n";
sleep(1);
...
if ($size1 <= 10 || $size3 <= 10 ){print "teLeap may have failed (double check pdb files for problems)\n";}
else {print "teLeap procedure appears to have run (double check .prmtop and .inpcrd files)\n";}

sleep(1);
print "\nteLeap on Query structure is complete\n\n";
